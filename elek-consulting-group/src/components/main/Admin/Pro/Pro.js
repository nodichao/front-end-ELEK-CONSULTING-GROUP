...
export function Pro() {
  ...
  const getPros = async () => {
    try {
      const response = await fetch(`https://elek-consulting-group-server-side.onrender.com/api/pro`, {
        method: "GET",
        credentials: "include",
      });
  ...
  const createPro = async (e) => {
    ...
    try {
      const response = await fetch("https://elek-consulting-group-server-side.onrender.com/api/user", {
        method: "POST",
        body: JSON.stringify({
          firstName: prenom,
          lastName: nom,
  ...
  const deletePro = async (id) => {
    try {
      const response = await fetch(`https://elek-consulting-group-server-side.onrender.com/api/user/${id}`, {
        method: "DELETE",
        credentials: "include",
      });
