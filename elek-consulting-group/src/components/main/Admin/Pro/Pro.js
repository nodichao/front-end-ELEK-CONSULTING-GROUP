...
export function Pro() {
  ...
  const getPros = async () => {
    try {
      const response = await fetch(`https://front-end-elek-consulting-group.vercel.app/api/pro`, {
        method: "GET",
        credentials: "include",
      });
  ...
  const deletePro = async (id) => {
    try {
      const response = await fetch(`https://front-end-elek-consulting-group.vercel.app/api/user/${id}`, {
        method: "DELETE",
        credentials: "include",
      });
