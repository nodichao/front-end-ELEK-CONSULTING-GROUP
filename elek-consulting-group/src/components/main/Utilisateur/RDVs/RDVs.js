...
export function RDVs() {
  ...
  const rdvHandler = async (e) => {
    ...
    try {
      const response = await fetch(`https://elek-consulting-group-server-side.onrender.com/api/rdv/${userObject._id}`, {
        method: "POST",
        credentials: "include",
        body: JSON.stringify({
          domain: domaine,
  ...
  const getRDVs = async () => {
    try {
      const response = await fetch(
        `https://elek-consulting-group-server-side.onrender.com/api/rdv/${userObject._id}`,
        {
          method: "GET",
          credentials: "include",
        }
  ...
  const deleteRDV = async (id)=>{
    ...
    try {
      const response = await fetch(
        `https://elek-consulting-group-server-side.onrender.com/api/rdv/${id}`,
        {
          method: "DELETE",
          credentials: "include",
        }
