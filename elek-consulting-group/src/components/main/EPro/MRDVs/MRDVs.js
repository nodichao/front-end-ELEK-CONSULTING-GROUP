...
export function MRDVs() {
  ...
  const getMRDVs = async () => {
    try {
      const response = await fetch(
        `https://front-end-elek-consulting-group.vercel.app/api/pro/rdv/${proObject._id}`,
        {
          method: "GET",
          credentials: "include",
        }
  ...
  const accept = async (id) => {
    ...
    console.log(rdv);
    try {
      const response = await fetch(`https://front-end-elek-consulting-group.vercel.app/api/rdv/${id}`, {
        method: "PUT",
        credentials: "include",
