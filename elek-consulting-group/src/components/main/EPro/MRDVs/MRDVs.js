...
export function MRDVs() {
  ...
  const getMRDVs = async () => {
    try {
      const response = await fetch(
        `https://elek-consulting-group-server-side.onrender.com/api/pro/rdv/${proObject._id}`,
        {
          method: "GET",
          credentials: "include",
        }
  ...
  const accept = async (id) => {
    ...
    console.log(rdv);
    try {
      const response = await fetch(`https://elek-consulting-group-server-side.onrender.com/api/rdv/${id}`, {
        method: "PUT",
        credentials: "include",
